...
function renderProducts(containerId, collectionKey, limit=null){
  ...
  if(items.length===0){
    container.innerHTML=`<div style="grid-column:1/-1;text-align:center;padding:3rem 2rem">
      ...
      <a href="https://wa.me/61404722166" class="btn-gold" style="display:inline-block">💬 WhatsApp to Order</a>
    </div>`;
    return;
  }
...
function renderFeatured(containerId, limit=6){
  ...
  if(all.length===0){
    container.innerHTML=`<div style="grid-column:1/-1;text-align:center;padding:3rem 2rem">
      ...
      <a href="https://wa.me/61404722166" class="btn-gold">💬 WhatsApp to Order</a>
    </div>`;
    return;
  }
    ...
    modal.innerHTML=`
      <div class="modal">
        ...
        <div class="modal-body">
          ...
          <a href="https://wa.me/61404722166?text=Hi%20GnA%20Ethnic%20Wears!%20I%20am%20interested%20in%20ordering:%20${encodeURIComponent(product.name)}%20-%20Please%20help%20me%20with%20sizing%20and%20availability."
            target="_blank"
